// RegionMarkerRectangle.swift
// 
// This is the first attempt, using a CGRect as the state for the region.

import Foundation
import SwiftUI

struct RegionMarkerRectangle : View {
...
struct RegionMarkerRectangle_Previews: PreviewProvider {
    static var previews: some View {
        RegionMarkerRectangle()
    }
}
